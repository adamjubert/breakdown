      ...
      <div class="alert-screen">
        ...
        <div class="flex-center">
          <div>
            <h2>Controls</h2>
            <ul>
              <li>left screen: <span>A</span> & <span>D</span> </li>
              <li>right screen: <span class="arrow">▲</span> & <span class="arrow">▼</span> </li>
              <li>mute sound: <span>Q</span></li>
            </ul>
          </div>
          <div>
            <h2>Power Ups</h2>
            <ul>
              <li><img src="img/star_blue.png" /> big paddle</li>
              <li><img src="img/star.png" /> remove bricks</li>
            </ul>
          </div>
        </div>
...
class Ball {
  ...
  //   } else {
  //     console.log("Error in ball.js #decreaseBallSpeed()");
  //   }
  // }
  //
  ...
  checkPongBoundaries() {
    ...
    if (this.x >= this.canvasWidth) {
      ...
      this.reset(550, 300, this.startingXSpeed, 3);
